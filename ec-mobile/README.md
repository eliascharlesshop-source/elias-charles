...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/2gYBOriJqJ)
...
```sh
npx nx serve ec-mobile
```

To create a production bundle:

```sh
npx nx build ec-mobile
```

To see all available targets to run for a project, run:

```sh
npx nx show project ec-mobile
```
