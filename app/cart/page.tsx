          ...
          {(cart?.lines?.length ?? 0) === 0 ? (
            <div className="text-center py-16 sm:py-24">
              ...
              <div className="mt-6">
                <Link
                  href="/collections"
                  className="inline-block rounded-md bg-primary px-4 py-3 text-base font-normal tracking-wider uppercase text-white hover:bg-dark"
                >
                  Continue Shopping
                </Link>
              </div>
            ...
            <div className="lg:grid lg:grid-cols-12 lg:gap-x-12 xl:gap-x-16">
              <div className="lg:col-span-7">
                    ...
                    <li key={product.id} className="flex py-6 sm:py-8">
                      ...
                      <div className="ml-4 flex flex-1 flex-col sm:ml-6">
                        ...
                        <div className="mt-4 flex flex-1 items-end justify-between">
                          ...
                          <button
                            type="button"
                            className="ml-4 text-sm font-medium text-primary hover:text-gray-500"
                ...
                <div className="mt-6">
                  <Link href="/collections" className="text-sm font-medium text-primary hover:text-gray-500">
                    ← Continue Shopping
                  </Link>
                </div>
              </div>
              ...
              <div className="mt-10 lg:col-span-5 lg:mt-0">
                <div className="rounded-lg bg-gray-50 px-4 py-6 sm:p-6 lg:p-8">
                  <SectionTitle className="text-lg font-medium">Order summary</SectionTitle>
                  ...
                  <div className="mt-6">
                    <form onSubmit={handleApplyPromo}>
                      ...
                      <div className="mt-1 flex space-x-2">
                        ...
                        <button
                          type="submit"
                          className="rounded-md bg-primary px-3 py-2 text-sm font-medium text-white shadow-sm hover:bg-dark focus:outline-none focus:ring-2 focus:ring-accent focus:ring-offset-2"
                        >
                          Apply
                        </button>
                      </div>
                  ...
                  <div className="mt-6">
                    <Link
                      href="/checkout"
                      className="w-full rounded-md border border-transparent bg-primary px-4 py-3 text-base font-medium text-white shadow-sm hover:bg-dark focus:outline-none focus:ring-2 focus:ring-accent focus:ring-offset-2 flex items-center justify-center"
                    >
                      Checkout
                    </Link>
                  </div>
