...
export default function SupplementsCollection() {
  ...
  const filters = [
    {
      ...
      options: [
        { value: "vitamins", label: "Vitamins", checked: false },
        { value: "minerals", label: "Minerals", checked: false },
        { value: "electrolytes", label: "Electrolytes", checked: false },
        { value: "oils", label: "Oils", checked: false },
        { value: "complexes", label: "Complexes", checked: false },
      ],
    },
    {
      id: "benefits",
      ...
      options: [
        ...
        { value: "immunity", label: "Immunity", checked: false },
    ...
    },
    {
      ...
      name: "Form",
      options: [
        { value: "capsules", label: "Capsules", checked: false },
        { value: "tablets", label: "Tablets", checked: false },
        { value: "powder", label: "Powder", checked: false },
        { value: "liquid", label: "Liquid", checked: false },
      ],
    },
  ]
      ...
      <div className="bg-cream">
        ...
        <div className="relative">
          <div className="absolute inset-0">
            <img src="/images/hero/streetlights-night-3.jpg" alt="Supplements Collection" className="h-full w-full object-cover" />
          ...
          <div className="relative px-4 sm:px-6 py-24 sm:py-32 lg:px-8 lg:py-48">
            <div className="mx-auto max-w-2xl text-center">
              <h1 className="text-3xl sm:text-4xl font-light tracking-tight text-white sm:text-5xl">Supplements</h1>
              <p className="mt-4 sm:mt-6 text-base sm:text-lg leading-7 sm:leading-8 text-white">
                Support your health and performance with our premium supplements.
              </p>
            </div>
          </div>
        </div>
        ...
        <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-12">
            <div>
              <h2 className="text-xl sm:text-2xl font-light tracking-tight text-primary">Supplements</h2>
