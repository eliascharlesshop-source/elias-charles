      ...
      <div className="bg-cream">
        ...
        <div className="relative">
          ...
          <div className="relative px-6 py-32 sm:py-40 lg:px-8 lg:py-56">
            <div className="mx-auto max-w-2xl text-center">
              <h1 className="text-4xl font-light tracking-tight text-white sm:text-5xl">Self Care</h1>
        ...
        <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-12">
            <h2 className="text-2xl font-light tracking-tight text-primary">Self Care Products</h2>
