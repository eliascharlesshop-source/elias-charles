...
export default function NutritionCollection() {
  ...
  const mockProducts = [
    ...
    {
      id: 3,
      title: "Superfood Blend",
      price: "$38",
      image: "/icons/placeholder.svg",
    },
    {
      id: 4,
      title: "Organic Nut Butter",
      price: "$16",
      image: "/icons/placeholder.svg",
    },
    {
  ...
  const filters = [
    {
      ...
      name: "Product Type",
      options: [
        { value: "protein", label: "Protein", checked: false },
        { value: "bars", label: "Bars", checked: false },
        { value: "superfoods", label: "Superfoods", checked: false },
        { value: "snacks", label: "Snacks", checked: false },
        { value: "drinks", label: "Drinks", checked: false },
      ],
    },
    {
      id: "dietary",
      ...
      options: [
        ...
        { value: "non-gmo", label: "Non-GMO", checked: false },
      ],
    },
    {
      id: "goals",
      ...
      options: [
        ...
        { value: "muscle", label: "Muscle Building", checked: false },
      ...
      <div className="bg-cream">
        ...
        <div className="relative">
          <div className="absolute inset-0">
            <img src="/products/straw-beach-hat.png" alt="Nutrition Collection" className="h-full w-full object-cover" />
          ...
          <div className="relative px-4 sm:px-6 py-24 sm:py-32 lg:px-8 lg:py-48">
            <div className="mx-auto max-w-2xl text-center">
              <h1 className="text-3xl sm:text-4xl font-light tracking-tight text-white sm:text-5xl">Nutrition</h1>
              <p className="mt-4 sm:mt-6 text-base sm:text-lg leading-7 sm:leading-8 text-white">
                Fuel your active lifestyle with our clean, natural nutrition products.
              </p>
            </div>
          </div>
        </div>
        ...
        <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-12">
            <div>
              <h2 className="text-xl sm:text-2xl font-light tracking-tight text-primary">Nutrition</h2>
