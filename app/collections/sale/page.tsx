  ...
  const filters = [
    {
      ...
      name: "Category",
      options: [
        { value: "mens", label: "Men's", checked: false },
        { value: "womens", label: "Women's", checked: false },
      ...
      <div className="bg-cream">
        ...
        <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-12">
            <h2 className="text-xl sm:text-2xl font-light tracking-tight text-primary">Sale Items</h2>
