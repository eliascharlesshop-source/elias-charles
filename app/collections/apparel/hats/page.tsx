  ...
  const filters = [
    {
      ...
      options: [
        ...
        { value: "bucket", label: "Bucket Hat", checked: false },
        { value: "sun", label: "Sun Hat", checked: false },
        { value: "trucker", label: "Trucker", checked: false },
      ],
    },
    {
      id: "color",
    ...
    },
    {
      ...
      options: [
        ...
        { value: "40+", label: "$40 & Above", checked: false },
      ],
    },
  ]
      ...
      <div className="bg-cream">
        ...
        <div className="relative">
          <div className="absolute inset-0">
            <img src="/images/ocean-wave-1.jpeg" alt="Hats Collection" className="h-full w-full object-cover" />
          ...
          <div className="relative px-4 sm:px-6 py-24 sm:py-32 lg:px-8 lg:py-48">
            <div className="mx-auto max-w-2xl text-center">
              <h1 className="text-3xl sm:text-4xl font-light tracking-tight text-white sm:text-5xl">Hats</h1>
              <p className="mt-4 sm:mt-6 text-base sm:text-lg leading-7 sm:leading-8 text-white">
                Top off your look with our stylish and functional hats for every occasion.
              </p>
            </div>
          </div>
        </div>
        ...
        <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-12">
            <div>
              <h2 className="text-xl sm:text-2xl font-light tracking-tight text-primary">Hats</h2>
