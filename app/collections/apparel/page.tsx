  ...
  return (
    <Layout>
      <div className="bg-[#fdf4ec]">
        ...
        {/* Subcategories */}
        <div className="bg-cream py-8 border-b border-border">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-6">
              <div className="text-sm uppercase tracking-widest steel-text mb-2">Featured Categories</div>
            </div>
            <div className="flex justify-center flex-wrap gap-2">
              {subcategories.map((subcategory) => (
                <Link
                  ...
                  className="inline-flex items-center rounded-md border border-border px-4 py-2 text-sm font-medium steel-text hover:bg-muted transition duration-200"
                >
                  {subcategory.name}
                </Link>
              ))}
        ...
        <div className="bg-cream py-12 border-t border-border">
          <div className="mx-auto max-w-7xl px-6 lg:px-8 text-center">
            <div className="text-xs uppercase tracking-widest steel-text mb-4">Summer 2023 • Issue 03</div>
            <p className="text-sm steel-text max-w-2xl mx-auto">
