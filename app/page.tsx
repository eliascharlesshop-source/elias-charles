      ...
      <section className="bg-cream">
        <div className="grid grid-cols-2 md:grid-cols-2">
          ...
          <div className="aspect-square overflow-hidden">
            <img src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/IMG_2417-LWKh1xR0ZNZxXgkgE8nBH30N0W1Qvm.png" alt="Modern minimalist style" className="h-full w-full object-cover hover:scale-105 transition-transform duration-500" />
          </div>
          <div className="aspect-square bg-cream flex items-center justify-center p-4 sm:p-6 md:p-8 lg:p-12">
            <div className="text-center max-w-xs lg:max-w-sm">
              <h3 className="text-lg sm:text-xl md:text-2xl lg:text-3xl uppercase tracking-wider text-gray-900 mb-3 sm:mb-4 leading-tight">Premium Quality</h3>
          ...
          <div className="aspect-square bg-cream flex items-center justify-center p-4 sm:p-6 md:p-8 lg:p-12">
            <div className="text-center max-w-xs lg:max-w-sm">
              <h3 className="text-lg sm:text-xl md:text-2xl lg:text-3xl uppercase tracking-wider text-gray-900 mb-3 sm:mb-4 leading-tight">Brand Essentials</h3>
          ...
          <div className="aspect-square overflow-hidden">
            <img src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/IMG_2416-7QmA2iBivptXRbcsu9MFsFxY4WF26V.png" alt="Comfortable lounge wear" className="h-full w-full object-cover hover:scale-105 transition-transform duration-500" />
          </div>

          {/* Row 3: Lifestyle Accessories */}
          <div className="aspect-square overflow-hidden">
            <img src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/IMG_2415-Vx9lUDoUBGp5ioLTfHrEGlNQdQe8ZE.png" alt="Signature cap" className="h-full w-full object-cover hover:scale-105 transition-transform duration-500" />
          </div>
          <div className="aspect-square bg-cream flex items-center justify-center p-4 sm:p-6 md:p-8 lg:p-12">
            <div className="text-center max-w-xs lg:max-w-sm">
              <h3 className="text-lg sm:text-xl md:text-2xl lg:text-3xl uppercase tracking-wider text-gray-900 mb-3 sm:mb-4 leading-tight">Accessories & More</h3>
