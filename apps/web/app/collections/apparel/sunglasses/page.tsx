  ...
  const filters = [
    {
      ...
      name: "Style",
      options: [
        { value: "wayfarer", label: "Wayfarer", checked: false },
        { value: "aviator", label: "Aviator", checked: false },
        { value: "round", label: "Round", checked: false },
        { value: "sport", label: "Sport", checked: false },
        { value: "oversized", label: "Oversized", checked: false },
      ],
    },
    {
      id: "features",
      ...
      options: [
        ...
        { value: "uv-protection", label: "UV Protection", checked: false },
        { value: "floating", label: "Floating", checked: false },
        { value: "scratch-resistant", label: "Scratch Resistant", checked: false },
      ],
    },
    {
      id: "price",
      ...
      options: [
        ...
        { value: "150+", label: "$150 & Above", checked: false },
      ],
    },
  ]
      ...
      <div className="bg-cream">
        ...
        <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-12">
            <div>
              <h2 className="text-xl sm:text-2xl font-light tracking-tight text-primary">Sunglasses</h2>
